...
CALL_CENTRE_PATH = Path(__file__).parent.joinpath(
    "models", CALL_CENTRE_FILE_NAME
)

# classic open jackson network example
JACKSON_NETWORK_FILE_NAME = "jackson_network.json"
JACKSON_NETWORK_PATH = Path(__file__).parent.joinpath(
    "models", JACKSON_NETWORK_FILE_NAME
)

# modified open jackson network example
THREE_NODE_FILE_NAME = "three_node_network.json"
THREE_NODE_PATH = Path(__file__).parent.joinpath(
    "models", THREE_NODE_FILE_NAME
)

# modified version of treatsim - 6 node network
SIX_NODE_UCC_FILE_NAME = "six_node_ucc.json"
SIX_NODE_UCC_PATH = Path(__file__).parent.joinpath(
    "models", SIX_NODE_UCC_FILE_NAME
)
...
MM1_RENEGE_PATH = Path(__file__).parent.joinpath(
    "models", MM1_RENEGE_FILE_NAME
)
